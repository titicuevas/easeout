                    ...
                    <main className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 mt-16">
                        <div className="text-center max-w-3xl mx-auto">
                            ...
                            <div className="mt-10 flex items-center justify-center gap-x-6">
                                <Link
                                    href={route('register')}
                                    className="rounded-md bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-all duration-300"
                                >
                                    Comienza Gratis
                                </Link>
                                <Link
